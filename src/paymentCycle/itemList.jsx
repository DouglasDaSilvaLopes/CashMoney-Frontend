...
import Input from '../common/template/form/inputCredits&Debits'
import If from '../common/template/operator/if'
        ...
        return list.map((item, index) => (
            <tr key={index} >
                ...
                <If test={this.props.showStatus}>
                    <td className='status'><Field name={`${this.props.field}[${index}].status`} component={Input} 
                        placeholder='informe o status' readOnly={this.props.readOnly} /></td>
                </If>
                <td className='list-credits-debts'>
